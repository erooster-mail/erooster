...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".auditable-build."0.2.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.15.0" { inherit profileName; };
  ...
  "git+https://gitlab.com/famedly/company/backend/libraries/axum-opentelemetry-middleware.git".axum-opentelemetry-middleware."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      prometheus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".prometheus."0.13.2" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".const_format."0.2.26" = overridableMkRustCrate (profileName: rec {
    name = "const_format";
    version = "0.2.26";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "939dc9e2eb9077e0679d2ce32de1ded8531779360b003b4a972a7a39ec263495"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "unknown".erooster."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ...
      clap = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."3.2.22" { profileName = "__noProfile"; };
  ...
  "unknown".erooster_imap."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      base64 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.13.0" { inherit profileName; };
      color_eyre = rustPackages."registry+https://github.com/rust-lang/crates.io-index".color-eyre."0.6.2" { inherit profileName; };
      const_format = rustPackages."registry+https://github.com/rust-lang/crates.io-index".const_format."0.2.26" { inherit profileName; };
      erooster_core = rustPackages."unknown".erooster_core."0.1.0" { inherit profileName; };
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.24" { inherit profileName; };
      nom = rustPackages."registry+https://github.com/rust-lang/crates.io-index".nom."7.1.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "erooster/jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.57" { profileName = "__noProfile"; };
      ...
      ${ if rootFeatures' ? "erooster/jaeger" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.35" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "erooster/jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.21.1" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry-jaeger."0.17.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "erooster_core/jaeger" then "async_trait" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".async-trait."0.1.57" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "erooster_core/jaeger" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.24" { inherit profileName; };
      ${ if rootFeatures' ? "erooster_core/jaeger" then "futures_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-executor."0.3.24" { inherit profileName; };
      ${ if rootFeatures' ? "erooster_core/jaeger" then "once_cell" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.15.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "erooster_core/jaeger" then "thiserror" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.35" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "erooster_core/jaeger" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.21.1" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opentelemetry_api."0.18.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "erooster_core/jaeger" then "futures_channel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-channel."0.3.24" { inherit profileName; };
      ${ if rootFeatures' ? "erooster_core/jaeger" then "futures_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.24" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".prometheus."0.13.2" = overridableMkRustCrate (profileName: rec {
    name = "prometheus";
    version = "0.13.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "45c8babc29389186697fe5a2a4859d697825496b83db5d0b65271cdc0488e88c"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "protobuf" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".threadpool."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "erooster/jaeger" || rootFeatures' ? "erooster_core/jaeger" then "num_cpus" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.13.1" { inherit profileName; };
    };
  });
